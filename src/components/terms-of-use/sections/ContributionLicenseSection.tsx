    ...
    <section className="mb-12" id="license">
      ...
      <div className="space-y-4 text-muted-foreground">
        <p>
          ...
          worldwide right, and <strong>license</strong> to host, use, copy,
          ...
          Contributions, and grant and <strong>authorize sublicenses</strong> of
          the foregoing. The use and distribution may occur in any media formats
          and through any media channels.
        </p>
        <p>
          This <strong>license</strong> will apply to any form, media, or
        ...
        <p>
          ...
          <strong>re-categorize</strong> any Contributions to place them in more
