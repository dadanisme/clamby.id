...
export function ProhibitedActivitiesSection() {
  return (
    <section className="mb-12" id="prohibited">
      <motion.h2
      ...
      <div className="space-y-4 text-muted-foreground">
        <p>
          ...
          in connection with any commercial <strong>endeavors</strong> except
        ...
        <ul className="list-disc list-inside ml-4 space-y-2">
          ...
          <li>
            Engage in <strong>unauthorized</strong> framing of or linking to the
            Services.
          </li>
          <li>
          ...
          <li>
            ...
            interchange formats (<strong>&quot;gifs&quot;</strong>), 1×1 pixels,
          ...
          <li>
            ...
            use or launch any <strong>unauthorized</strong> script or other
            software.
          </li>
          <li>
          ...
          <li>
            Make any <strong>unauthorized</strong> use of the Services,
            ...
            <strong>pretenses</strong>.
          </li>
          <li>
            Use the Services as part of any effort to compete with us or
            otherwise use the Services and/or the Content for any
            revenue-generating <strong>endeavor</strong> or commercial
            enterprise.
          </li>
